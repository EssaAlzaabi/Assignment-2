...
# Main program logic simulating a customer session with test cases
def main():
    ...
    cart.update_quantity(cart.items[1], 3)  # Update quantity of "The Lean Startup" to 3

    # Test: Remove item from cart
    cart.remove_item(cart.items[0])  # Remove "Atomic Habits" from cart
